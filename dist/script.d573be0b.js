...
'use strict'; //#region SCREEN - 1 - TITLE
//#endregion
//#region SCREEN - 2 - SLIDER - DONE

var s2sliderbtns = document.querySelectorAll('.sliderbtns__btn');
var s2sliders = document.querySelectorAll('.list__slide');
var s2playpausebtn = document.getElementById('playpause');
var s2btnnext = document.querySelector('.next');
var s2btnprev = document.querySelector('.prev');
var s2intervalMs = 7000;
var s2SlideInterval = setInterval(nextSlide, s2intervalMs);
var s2currentSlide = 0;
...
s2playpausebtn.addEventListener('click', function () {
